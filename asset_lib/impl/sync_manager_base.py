...
class SyncManagerBaseService:
    def __init__(self, state_management: SyncStateManagement, web_ip: str, udp_service: UdpComm, heartbeat_timeout_sec: int, saved_position):
    ...
    def run(self):
        try:
            packet = HeartBeatRequest(self.web_ip, self.udp_service.get_port(), self.saved_position)
